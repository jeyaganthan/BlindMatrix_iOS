...
@objc open class JeyPickerView: NSObject {
    
    private static let sharedInstance = JeyPickerView()
    ...
    */
    ...
    private class func controller(title: String? = nil,
        ...
        if let cc = UIWindow.currentController {
            if JeyPickerView.sharedInstance.isPresented == false {
                JeyPickerView.sharedInstance.isPresented = true
                ...
                vc.onWillDismiss = {
                    JeyPickerView.sharedInstance.isPresented = false
                }
...
public extension UIWindow {
    ...
    static var currentController: UIViewController? {
        UIApplication.keyWindow?.currentController?.view
